...
/// The [`HashIndex`] trait extends the [`Idx`] trait to include additional operations and
/// behaviours commonly expected from indices in a hypergraph.
///
 ...
 ************* Implementations *************
*/
impl<T> Idx for T where T: 'static + RawIndex + Clone + Default + PartialEq + PartialOrd {}

impl<T> HashIndex for T where T: Idx + Eq + core::hash::Hash {}
