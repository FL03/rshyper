    ...
    S: BuildHasher,
{
        ...
        Idx: Clone,
    {
        ...
        if !self.history().contains_node(data.id()) {
            ...
            // self.history_mut().add_edge(surface.id().clone());
            return Err(crate::HyperError::NodeNotFound);
        }
        // get the id of the surface
        ...
        VertexId<Idx>: core::borrow::Borrow<Q>,
    {
        self.nodes()
            .get(index)
            .ok_or(crate::HyperError::NodeNotFound)
    }
        ...
        EdgeId<Idx>: core::borrow::Borrow<Q>,
    {
        self.surfaces()
            .get(index)
            .ok_or_else(|| crate::HyperError::EdgeNotFound)
    }
        ...
        EdgeId<Idx>: core::borrow::Borrow<Q>,
    {
        self.surfaces_mut()
            .remove(index)
            .ok_or(crate::HyperError::EdgeNotFound)
    }
        ...
        EdgeId<Idx>: core::borrow::Borrow<Q>,
    {
        self.get_edge_weight_mut(index)
            ...
            .map_err(|_| crate::HyperError::EdgeNotFound)?;
        Ok(self)
    }
        ...
        VertexId<Idx>: core::borrow::Borrow<Q>,
    {
        self.get_node_weight_mut(index)
            ...
            .map_err(|_| crate::HyperError::NodeNotFound)?;
        Ok(self)
    }
}
