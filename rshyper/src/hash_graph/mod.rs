...
pub(crate) mod aliases {
    ...
    pub type HyperEdgeMap<K = Undirected, Idx = usize> = HashMap<EdgeId<Idx>, HashEdge<K, Idx>>;

    pub type HyperFacetMap<E, K, Idx = usize> = HashMap<EdgeId<Idx>, HashFacet<E, K, Idx>>;
